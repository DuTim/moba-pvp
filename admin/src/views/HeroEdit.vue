 ...
 * @LastEditors: Dutim
 * @LastEditTime: 2020-02-18 19:57:41
 -->
<template>
  <div>
    <h1 class>{{id ? '编辑':'新建'}}英雄</h1>
    <hr />
      ...
      <el-tabs type="card">
        <el-tab-pane label="基础信息">
          ...
          <el-form-item label="类型">
            <el-select v-model="model.categories" placeholder="类型" multiple>
              <el-option
          ...
          <el-form-item label="顺风出装">
            <el-select v-model="model.items1" placeholder="装备" multiple>
              <el-option v-for="item of items" :key="item._id" :label="item.name" :value="item._id"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="逆风出装">
            <el-select v-model="model.items2
        " placeholder="装备" multiple>
              <el-option v-for="item of items" :key="item._id" :label="item.name" :value="item._id"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-row type="flex" style="flex-wrap:wrap">
            <el-col :md="12" v-for="(item, index) in model.skills" :key="index">
              ...
              <el-form-item label="消耗">
                <el-input v-model="item.cast"></el-input>
              </el-form-item>
...
export default {
  created() {
    ...
    console.log(`${this.uploadurl} url`);
    this.fetchHeroes();
  },
  props: { id: {} },
  data() {
    return {
      categories: [],
      headers: {
        Authorization: "bear" //从cookie里获取token，并赋值  Authorization ，而不是token
      },
      items: [],
      model: {
        name: "",
